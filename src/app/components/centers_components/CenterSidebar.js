  ...
  return (
    <>
      ...
      <button
        ...
        className="absolute top-4 left-4 z-50 sm:hidden p-1 bg-red-500 text-white rounded-md focus:outline-none hover:bg-red-600"
      >
        {/* Icon for the Arrow */}
        {isOpen ? (
          <svg
        ...
        <div className="h-full p-6 overflow-y-auto flex flex-col justify-start">
          ...
          <div className="mt-4">
            ...
            <div className="flex mt-4 space-x-2">
              <span className="font-lato w-[120px] h-[35px] bg-[#e3646f] text-center p-[5px] rounded-[23px]">
                Algorithms
              </span>
              <span className="font-lato w-[100px] h-[35px] bg-[#e3646f] text-center p-[5px] rounded-[23px]">
                Design
              </span>
            </div>
          </div>
