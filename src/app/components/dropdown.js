...
export const DropDown = () => {
  return (
    <div className="w-full lg:w-auto lg:flex lg:flex-row lg:items-center lg:justify-center">
      <select className="mr-2 text-xs text-white bg-red-800 lg:w-32 p-1 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-500 mb-2 lg:mb-0">
      ...
      {/* Add other select elements here */}
    </div>
  );
};
