...
export default function PSideBar() {
  return (
    <aside
      id="logo-sidebar"
      className="flex top-30 left-0 z-40 md:w-80 lg:w-96 lg:h-screen" // Changed width from w-64 to w-80
      aria-label="Sidebar"
    >
      <div className="h-auto p-6 overflow-y-auto bg-white lg:bg-gray-300">
        <img
          src={`/PublicD/RProfile.png`}
        ...
        <ul>
          ...
          <li className="py-1">
            <div className="flex items-center text-gray-900 rounded-lg dark:text-black">
              ...
              <span className="text-xs px-2">www.linkedin.com/john-doe</span>
            </div>
          </li>
          <li className="py-1">
            <div className="flex items-center text-gray-00 rounded-lg dark:text-black">
              ...
              <span className="text-xs px-2">www.facebook.com/john-doe</span>
            </div>
          </li>
        </ul>
      </div>
