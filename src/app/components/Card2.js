...
const Card2 = ({ user }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center bg-white rounded-lg overflow-hidden shadow-lg p-4">
          ...
          <div className="sdg-list">
            <ul className="flex flex-wrap">
              {user.sdg.map((goal, index) => (
                <li
                  key={index}
                  className="text-black-600 bg-red-500 rounded-lg px-2 py-1 mb-1 border border-black-300 text-sm"
