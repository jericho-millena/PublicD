      ...
      <path fillRule="evenodd" d="M10 2a8 8 0 105.293 13.707l3.414 3.414a1 1 0 001.414-1.414l-3.414-3.414A8 8 0 0010 2zM5 10a5 5 0 1110 0A5 5 0 015 10z" clipRule="evenodd" />
        ...
        <div className="mr-20 mt-20 ml-20">
          ...
          <p className="text-gray-600 text-justify">
            The Knowledge, Innovation, and Science Technology (KIST) Park is a pioneering economic
            zone established by Batangas State University (BatStateU). It aims to foster collaboration
            between academia and industry, promote technological innovation, and drive economic growth
            in the region. The KIST Park provides a conducive environment for research, development,
            and commercialization of innovative products and services. It offers facilities for startups,
            incubators, and research centers, as well as opportunities for technology transfer and knowledge
            sharing. By attracting businesses and researchers, the KIST Park aims to position Batangas State
            University as a leading center for innovation and technological advancement in the Philippines.
          </p> <br></br>
...
<br></br>
     ...
     <div className="text-center">
      <div className="w-[200px] h-[100px] bg-[#effff] px-[20px] py-[10px] border-l-[2.5px] border-black flex flex-col justify-center">
        ...
        <div className="font-lato text-[15px] text-[#333333]">Articles</div>
      </div>
    </div>
    ...
    <div className="text-center">
      <div className="w-[200px] h-[100px] bg-[#effff] px-[20px] py-[10px] border-l-[2.5px] border-black flex flex-col justify-center">
        ...
        <div className="font-lato text-[15px] text-[#333333]">Review Articles</div>
      </div>
    </div>
  </div>
  </div>
  ...
  <div className="flex gap-4">
    <div className="text-center">
      <div className="w-[200px] h-[100px] bg-[#effff] px-[20px] py-[10px] border-l-[2.5px] border-black flex flex-col justify-center">
        ...
        <div className="font-lato text-[15px] text-[#333333]">Reviewed Article</div>
      </div>
    </div>
    ...
    <div className="text-center">
      <div className="w-[200px] h-[100px] bg-[#effff] px-[20px] py-[10px] border-l-[2.5px] border-black flex flex-col justify-center">
        ...
        <div className="font-lato text-[15px] text-[#333333]">Hosting Event</div>
      </div>
    </div>
    ...
    <div className="text-center">
      <div className="w-[200px] h-[100px] bg-[#effff] px-[20px] py-[10px] border-l-[2.5px] border-black flex flex-col justify-center">
        <span className="text-black text-[25px]">9012</span>
        <div className="font-lato text-[15px] text-[#333333]">Oral Presentation</div>
      </div>
    </div>
    ...
    <div className="text-center">
      <div className="w-[200px] h-[100px] bg-[#effff] px-[20px] py-[10px] border-l-[2.5px] border-black flex flex-col justify-center">
        <span className="text-black text-[25px]">123</span>
        <div className="font-lato text-[15px] text-[#333333]">Invited Talk</div>
      </div>
    </div>
  </div>
</div>
...
<div className="flex justify-center items-center mt-4">
 ...
 <h1 className="font-lato text-2xl flex items-center">
            {/* newspaper icon */}
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
