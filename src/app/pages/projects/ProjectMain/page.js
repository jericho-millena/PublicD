    ...
    <main>
      ...
      <div class="p-4 center mx-10 my-2">
        <div class="p-4">
          ...
          <div className="py-5">
            <h1 class="text-xl text-black-800">Description </h1>
          </div>
          <div className="grid grid-cols-[4fr_3fr] gap-4 mb-4">
            <div className="">
              <p>
                ...
                sollicitudin mauris. Nulla a tristique purus. Donec odio sapien,
                bibendum quis nisi ut, convallis tempor augue. Curabitur nunc
                lacus, posuere sed semper in, dignissim in nunc. Sed vel
                volutpat erat, eget malesuada urna. Aenean tellus elit, maximus
                at nunc nec, congue condimentum nulla. Quisque nec malesuada
                mauris. Cras nisl ipsum, suscipit vitae malesuada eget, tempor
                tristique odio. Vivamus pharetra ullamcorper tellus, et faucibus
                ligula hendrerit sed. Integer vestibulum convallis nisl, ac
                tincidunt nulla lobortis ac. Cras iaculis metus vitae felis
                laoreet facilisis. Integer vitae tempor augue, a fermentum enim.
                Vivamus urna eros, congue sed molestie sed, aliquet id orci. Nam
                tincidunt leo ut turpis dictum consectetur.
              </p>
            </div>
            <div className="py-5">
              <h1 class="text-xl text-black-800 h-90">Document Link </h1>
            </div>
            <div className="">
          ...
          <div class="grid grid-cols-2 gap-4 mb-4">
            <div className="flex items-center justify-center rounded bg-gray-50 h-85 dark:bg-gray-800">
              {" "}
              <img
                src="/socials/lab.png"
                className="w-full h-full object-fit-cover"
              />
              <p className="text-        text-gray-400              dark:text-gray-500"></p>
            </div>
            <div className="flex items-center justify-center rounded bg-gray-50 h-85 dark:bg-gray-800">
              {" "}
              <img
                src="/socials/mess.png"
                className="w-full h-full object-fit-cover"
              />
